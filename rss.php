...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
	<channel>
		...
		<atom:link href="<?php echo ROOT_URL; ?>/rss.php" rel="self" type="application/rss+xml" />
		...
		<item>
			...
			<link><?php echo ROOT_URL; ?>/single.php?post_id=<?php echo $row['post_id']; ?></link>
			<guid><?php echo ROOT_URL; ?>/single.php?post_id=<?php echo $row['post_id']; ?></guid>
			<author><?php echo $row['email']; ?> (<?php echo $row['username']; ?>)</author>
			<pubDate><?php echo rss_date($row['date']); ?></pubDate>
			<description><![CDATA[
				<img src="<?php echo ROOT_URL; ?>/<?php image_url($row['post_id'], 'large'); ?>">
				<br>
